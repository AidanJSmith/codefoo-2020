...
data = [(dict(start=1,days=3,pay=750,name=r'Robbie\'s Research')),(dict(start=2,days=2,pay=500,name=r'A Parent\'s Love')),(dict(start=1,days=4,pay=920,name=r'The Weapon Connoisseur')),(dict(start=3,days=8,pay=1050,name=r'Sunshroom Sensing')),(dict(start=5,days=1,pay=200,name=r'Sunken Treasure')),(dict(start=3,days=4,pay=400,name=r'Cooking with Koko')),(dict(start=7,days=5,pay=1200,name=r'Arrows of Burning Heat')),(dict(start=12,days=3,pay=370,name=r'Stalhorse: Pictured!')),(dict(start=6,days=8,pay=840,name=r'Curry for What Ails You')),(dict(start=19,days=2,pay=165,name=r'The Jewel Trade')),(dict(start=23,days=7,pay=1520,name=r'Slated for Upgrades')),(dict(start=14,days=4,pay=600,name=r'Medicinal Molduga')),(dict(start=8,days=3,pay=430,name=r'Tools of the Trade')),(dict(start=20,days=7,pay=1100,name=r'A Gift for the Great Fairy')),(dict(start=28,days=3,pay=590,name=r'A Rare Find')),(dict(start=10,days=4,pay=900,name=r'Frog Catching')),(dict(start=13,days=6,pay=230,name=r'Luminous Stone Gathering')),(dict(start=25,days=4,pay=750,name=r'A Freezing Rod')),(dict(start=9,days=1,pay=460,name=r'Rushroom Rush!')),(dict(start=16,days=10,pay=780,name=r'The Hero\'s Cache')),(dict(start=4,days=5,pay=410,name=r'A Gift of Nightshade')),(dict(start=11,days=3,pay=570,name=r'Lynel Safari')),(dict(start=7,days=2,pay=1200,name=r'Riddles of Hyrule')),(dict(start=2,days=23,pay=2100,name=r'An Ice Guy'))]
